...
from lms.views import LessonListAPIView, LessonCreateAPIView, LessonUpdateAPIView, LessonDestroyAPIView, \
...
urlpatterns = [
    ...
    path('lesson/<int:pk>/retrieve/', LessonRetrieveAPIView.as_view(), name='lesson-retrieve'),
